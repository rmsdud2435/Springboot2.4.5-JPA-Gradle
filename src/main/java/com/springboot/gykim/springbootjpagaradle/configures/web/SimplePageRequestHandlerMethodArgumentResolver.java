package com.springboot.gykim.springbootjpagaradle.configures.web;
...
public class SimplePageRequestHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
  ...
  public Object resolveArgument(
    ...
    // TODO 구현이 필요 합니다.
    Long offset = Long.parseLong(offsetString == null? "0": offsetString);
    int size = Integer.parseInt(sizeString == null? "5": sizeString);
